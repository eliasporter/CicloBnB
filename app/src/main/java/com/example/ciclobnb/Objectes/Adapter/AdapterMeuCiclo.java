...
public class AdapterMeuCiclo extends RecyclerView.Adapter<AdapterMeuCiclo.ViewHolder> {
    ...
    public AdapterMeuCiclo(ArrayList<Ofereix> ofereixes, Context context,Usser u) {
    ...
    @Override
    public AdapterMeuCiclo.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
    ...
    @Override
    public void onBindViewHolder(AdapterMeuCiclo.ViewHolder viewHolder, final int position) {
